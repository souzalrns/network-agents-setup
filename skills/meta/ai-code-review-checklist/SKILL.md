...
priority: P0
description: >-
  Checklist vivo de erros recorrentes ja cometidos por IA em codigo gerado (RLS, IDOR, segredos hardcoded, onboarding de registo). Activar antes de aprovar qualquer PR ou mudanca gerada por IA.
requires: []
---
...
Antes de aprovar qualquer PR/mudança gerada por IA.
...
Checklist vivo de erros recorrentes já cometidos por IA em código/trabalho gerado — não é teoria, é padrão observado repetir-se. Adicionar entrada nova sempre que um erro novo for identificado e corrigido, para que revisões futuras sejam mais rápidas.
...
Advisory — esta skill orienta, não aplica. Nada no runner ou no agente valida mecanicamente que o checklist foi consultado; a conformidade depende de quem revê a mudança.
...
Sem atribuição externa — construído a partir de padrões de erro reais observados a repetir-se, não de uma skill de terceiros (ao contrário da maioria das outras skills deste directório, que citam o ECC).
